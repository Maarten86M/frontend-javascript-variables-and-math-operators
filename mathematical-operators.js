...
// ==========================================
const residence = "Tilburg";
const procince = "Brabant";
const locaton = residence + ", "  +procince;
console.log(locaton);